...
3. Increase the version numbers in any examples files, the [gemspec file](adventure-theme.gemspec), and the [package.json](package.json) to the new version that this Pull Request would represent. The versioning scheme we use is [SemVer](http://semver.org/).
